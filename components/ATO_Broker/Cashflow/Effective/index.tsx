...
export default function EffectiveRate() {
  ...
  const { isMobile, setLoan_InterestRate, Loan_interestRate } = ctx;
            ...
            <Grid.Col span={12}>
              <span>
                <JumboTitle
                  ...
                  fw={600}
                >
                  Set the loan's effective interest rate
                </JumboTitle>
              </span>
            </Grid.Col>
          </Grid>
        ...
        >
          <Stack>
            <TextInput
              ...
              onBlur={() => {
                const raw = Loan_interestRate.toString();
                const parsed = Number(raw.replace(/,/g, ''));
                if (!isNaN(parsed)) {
